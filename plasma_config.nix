{
  programs.plasma = {
    ...
    configFile = {
      ...
      "kglobalshortcutsrc"."ActivityManager"."_k_friendly_name" = "Gestor de actividades";
      "kglobalshortcutsrc"."KDE Keyboard Layout Switcher"."_k_friendly_name" = "Selector de distribución del teclado";
      "kglobalshortcutsrc"."kaccess"."_k_friendly_name" = "Accesibilidad";
      "kglobalshortcutsrc"."kcm_touchpad"."_k_friendly_name" = "Panel táctil";
      ...
      "kglobalshortcutsrc"."kmix"."_k_friendly_name" = "Volumen del sonido";
      "kglobalshortcutsrc"."ksmserver"."_k_friendly_name" = "Gestión de sesiones";
      "kglobalshortcutsrc"."kwin"."_k_friendly_name" = "KWin";
      "kglobalshortcutsrc"."mediacontrol"."_k_friendly_name" = "Controlador multimedia";
      ...
      "kglobalshortcutsrc"."org.kde.plasma.emojier.desktop"."_k_friendly_name" = "Selector de emojis";
      "kglobalshortcutsrc"."org.kde.spectacle.desktop"."_k_friendly_name" = "Spectacle";
      "kglobalshortcutsrc"."org_kde_powerdevil"."_k_friendly_name" = "Gestión de energía";
      "kglobalshortcutsrc"."plasmashell"."_k_friendly_name" = "Plasma";
      "kglobalshortcutsrc"."systemsettings.desktop"."_k_friendly_name" = "Preferencias del sistema";
      ...
      "kwinrc"."Tiling/b0256ec1-6eb1-551f-a455-62b40d3c74fe"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
