{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      ActivityManager.switch-to-activity-f7913d34-39ed-4da8-bb4e-b7c3132f4af5 = [];
      ...
      "org.chromium.Chromium"."13297B1FB5F0AC730B94897BB10CFDF9-default-action" = [];
      ...
      plasmashell."activate application launcher" = ["Meta\\,Meta" "Alt+F1\\,Activar el lanzador de aplicaciones"];
    ...
    configFile = {
      ...
      dolphinrc.ExtractDialog."2560x1440 screen: Height" = 698;
      dolphinrc.ExtractDialog."2560x1440 screen: Width" = 1602;
      dolphinrc.ExtractDialog."DirHistory[$e]" = "$HOME/Escritorio/";
      dolphinrc.General.ViewPropsTimestamp = "2024,8,26,10,10,17.963";
      dolphinrc.IconsMode.PreviewSize = 112;
      dolphinrc."KFileDialog Settings"."Places Icons Auto-resize" = false;
      dolphinrc."KFileDialog Settings"."Places Icons Static Size" = 22;
      kactivitymanagerdrc.activities.bd92301f-1c92-41c0-a791-f97d80b539be = "Por omisión";
      kactivitymanagerdrc.activities.f7913d34-39ed-4da8-bb4e-b7c3132f4af5 = "Por omisión";
      kactivitymanagerdrc.main.currentActivity = "f7913d34-39ed-4da8-bb4e-b7c3132f4af5";
      ...
      katerc."KTextEditor::Search"."Search History" = "mount,concat,concat:js,cssmin,pro,production,mongo,kfind,ksysgu,yakua,services,ironin,steam,3,clang,PATH_TO_PYTHON,$LOCATION_ECOASSIST_FILES,EcoAssist.command";
      ...
      kdeglobals."DirSelect Dialog"."DirSelectDialog Size" = "1294,762";
      ...
      khotkeysrc.Data_1_1.Comment = "Comentario";
      khotkeysrc.Data_1_1.Enabled = true;
      khotkeysrc.Data_1_1.Name = "Búsqueda";
      ...
      khotkeysrc.Data_1_1Triggers.Comment = "Acción sencilla";
      ...
      khotkeysrc.Data_2.Comment = "Este grupo contiene varios ejemplos que muestran la mayoría de las características de KHotkeys. (Observe que este grupo y todas sus acciones está inhabilitado por omisión).";
      khotkeysrc.Data_2.DataCount = 8;
      khotkeysrc.Data_2.Enabled = false;
      khotkeysrc.Data_2.ImportId = "kde32b1";
      khotkeysrc.Data_2.Name = "Ejemplos";
      ...
      khotkeysrc.Data_2_1.Comment = "Tras pulsar Ctrl+Alt+I, se activará la ventana de KSIRC, si la hay. Sencillo.";
      khotkeysrc.Data_2_1.Enabled = false;
      khotkeysrc.Data_2_1.Name = "Activar la ventana de KSIRC";
      ...
      khotkeysrc.Data_2_1Actions0Window.Comment = "Ventana de KSIRC";
      ...
      khotkeysrc.Data_2_1Triggers.Comment = "Acción sencilla";
      ...
      khotkeysrc.Data_2_1Triggers0.Uuid = "{6fbb1f54-e4c8-4225-b564-afcccf817227}";
      khotkeysrc.Data_2_2.Comment = "Tras pulsar Alt+Ctrl+H se simulará la entrada de «Hola» como si lo hubiera tecleado. Es especialmente útil si tiene que escribir cosas frecuentemente (como «unsigned»). Todas las pulsaciones en la entrada se separan por dos puntos «:». Tenga en cuenta que «pulsaciones» significa realmente eso, por lo que debe escribir lo que realmente quiere pulsar en el teclado. En la tabla de abajo, la columna de la izquierda muestra la entrada y la de la derecha qué escribir.\n\n«intro» (nueva línea)                   Intro o Return\na (a minúscula)                           A\nA (a  mayúscula)                          Mayúsculas+A\n: (dos puntos)                            Mayúsculas+;\n« » (espacio)                           Espacio";
      khotkeysrc.Data_2_2.Enabled = false;
      khotkeysrc.Data_2_2.Name = "Teclee «Hola»";
      ...
      khotkeysrc.Data_2_2Triggers.Comment = "Acción sencilla";
      ...
      khotkeysrc.Data_2_2Triggers0.Uuid = "{faef411f-35fd-48ce-aaee-f7c37d5aa563}";
      khotkeysrc.Data_2_3.Comment = "Esta acción ejecuta Konsole, cuando se pulsa Ctrl+Alt+T.";
      khotkeysrc.Data_2_3.Enabled = false;
      khotkeysrc.Data_2_3.Name = "Ejecutar Konsole";
      ...
      khotkeysrc.Data_2_3Triggers.Comment = "Acción sencilla";
      ...
      khotkeysrc.Data_2_4Conditions0Window0.Title = "Qt Designer, por Trolltech";
      ...
      khotkeysrc.Data_2_4Triggers0.Uuid = "{259ca8ef-0a14-4bac-b626-290ada760e41}";
      khotkeysrc.Data_2_5.Comment = "Pulsando Alt+Ctrl+W se ejecutará una llamada de D-Bus que mostrará el minicli. Puede usar cualquier tipo de llamada D-Bus, igual que con la herramienta «qdbus» de la línea de órdenes.";
      khotkeysrc.Data_2_5.Enabled = false;
      khotkeysrc.Data_2_5.Name = "Ejecuta una llamada D-Bus «qdbus org.kde.krunner /App display»";
      ...
      khotkeysrc.Data_2_5Triggers.Comment = "Acción sencilla";
      ...
      khotkeysrc.Data_2_6Actions0DestinationWindow.Comment = "Ventana de XMMS";
      ...
      khotkeysrc.Data_2_6Actions0DestinationWindow0.Comment = "Ventana del reproductor XMMS";
      ...
      khotkeysrc.Data_2_6Triggers.Comment = "Acción sencilla";
      ...
      khotkeysrc.Data_2_7_1.Name = "Atrás";
      ...
      khotkeysrc.Data_2_7_1Triggers.Comment = "Lanzador-de-gestos";
      ...
      khotkeysrc.Data_2_7_2.Name = "Adelante";
      ...
      khotkeysrc.Data_2_7_2Triggers.Comment = "Lanzador-de-gestos";
      ...
      khotkeysrc.Data_2_7_3.Name = "Arriba";
      ...
      khotkeysrc.Data_2_7_3Triggers.Comment = "Lanzador-de-gestos";
      ...
      khotkeysrc.Data_2_7_4.Name = "Volver a cargar";
      ...
      khotkeysrc.Data_2_7_4Triggers.Comment = "Lanzador-de-gestos";
      ...
      khotkeysrc.Data_2_8.Comment = "Tras pulsar Win+E (Tux+E), se arrancará el navegador y se abrirá http://www.kde.org . Puede ejecutar cualquier clase de órdenes mediante (Alt+F2).";
      khotkeysrc.Data_2_8.Enabled = false;
      khotkeysrc.Data_2_8.Name = "Ir al sitio web de KDE";
      ...
      khotkeysrc.Data_2_8Triggers.Comment = "Acción sencilla";
      ...
      khotkeysrc.Data_2_8Triggers0.Uuid = "{d0a26817-d6f4-4d12-bb7b-9fe30bec3772}";
      khotkeysrc.Data_3.Comment = "Gestos básicos de Konqueror.";
      khotkeysrc.Data_3.DataCount = 14;
      khotkeysrc.Data_3.Enabled = true;
      khotkeysrc.Data_3.ImportId = "konqueror_gestures_kde321";
      khotkeysrc.Data_3.Name = "Gestos de Konqueror";
      khotkeysrc.Data_3.SystemGroup = 0;
      khotkeysrc.Data_3.Type = "ACTION_DATA_GROUP";
      khotkeysrc.Data_3Conditions.Comment = "Ventana de Konqueror";
      ...
      khotkeysrc.Data_3_1.Comment = "Pulse, izquierda, suelte.";
      khotkeysrc.Data_3_1.Enabled = true;
      khotkeysrc.Data_3_1.Name = "Atrás";
      khotkeysrc.Data_3_1.Type = "SIMPLE_ACTION_DATA";
      khotkeysrc.Data_3_10.Comment = "Estilo Opera: Pulse, arriba, suelte.\nATENCIÓN: Choca con «Nueva pestaña» y está inhabilitado por omisión.";
      khotkeysrc.Data_3_10.Enabled = false;
      khotkeysrc.Data_3_10.Name = "Detener la carga";
      ...
      khotkeysrc.Data_3_10Triggers.Comment = "Lanzador-de-gestos";
      ...
      khotkeysrc.Data_3_11.Comment = "Subir en la estructura de directorios/URL.\nEstilo-Mozilla: Pulse, subir, izquierda, arriba, suelte.";
      khotkeysrc.Data_3_11.Enabled = true;
      khotkeysrc.Data_3_11.Name = "Arriba";
      ...
      khotkeysrc.Data_3_11Triggers.Comment = "Lanzador-de-gestos";
      ...
      khotkeysrc.Data_3_12Triggers.Comment = "Lanzador-de-gestos";
      ...
      khotkeysrc.Data_3_13.Comment = "Pulse, suba, derecha, suelte.";
      khotkeysrc.Data_3_13.Enabled = true;
      khotkeysrc.Data_3_13.Name = "Activar la siguiente pestaña";
      ...
      khotkeysrc.Data_3_13Triggers.Comment = "Lanzador-de-gestos";
      ...
      khotkeysrc.Data_3_14.Comment = "Pulse, suba, izquierda, suelte.";
      khotkeysrc.Data_3_14.Enabled = true;
      khotkeysrc.Data_3_14.Name = "Activar la pestaña anterior";
      ...
      khotkeysrc.Data_3_14Triggers.Comment = "Lanzador-de-gestos";
      ...
      khotkeysrc.Data_3_1Triggers.Comment = "Lanzador-de-gestos";
      ...
      khotkeysrc.Data_3_2.Comment = "Pulse, abajo, arriba, abajo, suelte.";
      khotkeysrc.Data_3_2.Enabled = true;
      khotkeysrc.Data_3_2.Name = "Duplicar pestaña";
      ...
      khotkeysrc.Data_3_2Triggers.Comment = "Lanzador-de-gestos";
      ...
      khotkeysrc.Data_3_3.Comment = "Pulse, abajo, arriba, suelte.";
      khotkeysrc.Data_3_3.Enabled = true;
      khotkeysrc.Data_3_3.Name = "Duplicar la ventana";
      ...
      khotkeysrc.Data_3_3Triggers.Comment = "Lanzador-de-gestos";
      ...
      khotkeysrc.Data_3_4.Comment = "Pulse, derecha, suelte.";
      khotkeysrc.Data_3_4.Enabled = true;
      khotkeysrc.Data_3_4.Name = "Adelante";
      ...
      khotkeysrc.Data_3_4Triggers.Comment = "Lanzador-de-gestos";
      ...
      khotkeysrc.Data_3_5.Comment = "Pulse, abajo, medio arriba, derecha, abajo, suelte.\n(Dibujando una «h» minúscula).";
      khotkeysrc.Data_3_5.Enabled = true;
      khotkeysrc.Data_3_5.Name = "Carpeta personal";
      ...
      khotkeysrc.Data_3_5Triggers.Comment = "Lanzador-de-gestos";
      ...
      khotkeysrc.Data_3_6.Comment = "Pulse derecha, abajo, derecha, suelte.\nEstilo Mozilla: Pulse, abajo, derecha, suelte.";
      khotkeysrc.Data_3_6.Enabled = true;
      khotkeysrc.Data_3_6.Name = "Cerrar la pestaña";
      ...
      khotkeysrc.Data_3_6Triggers.Comment = "Lanzador-de-gestos";
      ...
      khotkeysrc.Data_3_7Triggers.Comment = "Lanzador-de-gestos";
      ...
      khotkeysrc.Data_3_8.Comment = "Pulse, abajo, suelte.";
      khotkeysrc.Data_3_8.Enabled = true;
      khotkeysrc.Data_3_8.Name = "Nueva ventana";
      ...
      khotkeysrc.Data_3_8Triggers.Comment = "Lanzador-de-gestos";
      ...
      khotkeysrc.Data_3_9.Comment = "Pulse, arriba, abajo, suelte.";
      khotkeysrc.Data_3_9.Enabled = true;
      khotkeysrc.Data_3_9.Name = "Volver a cargar";
      ...
      khotkeysrc.Data_3_9Triggers.Comment = "Lanzador-de-gestos";
      ...
      kwinrc.Desktops.Id_1 = "b85a5f8f-c53f-49c0-a855-cf53bf3dae97";
      ...
      kwinrc."Tiling/188c7cee-c328-5f29-995b-051de362b7ec".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":\x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}\x5d}";
      kwinrc."Tiling/285712a6-31d1-5e3a-95e8-b6f4629caf9f".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}x5d}";
      kwinrc."Tiling/2c95023d-574c-5bae-8921-442fbf2c7817".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":\x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}\x5d}";
      kwinrc."Tiling/4b2b29e4-e62a-5e81-9bda-e67583b66888".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      kwinrc."Tiling/55e3a03a-7e0e-5b4b-bece-66b509b4f4ab".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      kwinrc."Tiling/b0256ec1-6eb1-551f-a455-62b40d3c74fe".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}x5d}";
      kwinrc."Tiling/b85a5f8f-c53f-49c0-a855-cf53bf3dae97/a3c70934-90ac-49db-bde6-c3cde54dd58d".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      kwinrc."Tiling/d6d2d86f-0518-5f00-996e-20e35f919aab".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":\x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}\x5d}";
      kwinrc."Tiling/f3379d9d-677c-5ec3-b40f-75526294a305".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      kwinrc.Xwayland.Scale = 1;
      plasma-localerc.Formats.LANG = "es_ES.UTF-8";
      plasmanotifyrc."Applications/discord".Seen = true;
      plasmanotifyrc."Applications/firefox".Seen = true;
      plasmanotifyrc."Applications/hydralauncher".Seen = true;
      ...
      spectaclerc.ImageSave.lastImageSaveAsLocation = "file:///home/arturo/Escritorio/Captura de pantalla_20251023_160925.png";
      spectaclerc.ImageSave.lastImageSaveLocation = "file:///home/arturo/Imágenes/Capturas de pantalla/Captura de pantalla_20251216_131337.png";
      spectaclerc.ImageSave.translatedScreenshotsFolder = "Capturas de pantalla";
      spectaclerc.Save.lastSaveAsLocation = "file:///home/arturo/Escritorio/Documentos kerma/Reclamacion horas.png";
      spectaclerc.Save.lastSaveLocation = "file:///home/arturo/Escritorio/Documentos kerma/Reclamacion horas.png";
      spectaclerc.VideoSave.translatedScreencastsFolder = "Videocapturas de pantalla";
    };
    dataFile = {
      "kate/anonymous.katesession"."Document 0".URL = "file:///home/arturo/.config/dolphinrc";
      ...
      "kate/anonymous.katesession".MainWindow0."2560x1440 screen: Window-Maximized" = true;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-3-LastSize = 208;
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-3-SectSizes = 0;
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-3-Splitter = 2136;
      ...
      "kate/anonymous.katesession"."MainWindow0 Settings"."2560x1440 screen: Window-Maximized" = true;
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/arturo\\/Escritorio\\/UDo\\/udo-core\\/db\\/patches\\/5.14.0\\/patches.json".CursorColumn = 116;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/arturo\\/Escritorio\\/UDo\\/udo-core\\/db\\/patches\\/5.14.0\\/patches.json".CursorLine = 5;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/arturo\\/Escritorio\\/UDo\\/udo-core\\/db\\/patches\\/5.14.0\\/patches.json"."Dynamic Word Wrap" = true;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/arturo\\/Escritorio\\/UDo\\/udo-core\\/db\\/patches\\/5.14.0\\/patches.json".JumpList = "";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/arturo\\/Escritorio\\/UDo\\/udo-core\\/db\\/patches\\/5.14.0\\/patches.json".TextFolding = "{\"checksum\":\"8340265ba7453c4794727cbb1ca1c4f85bebcea7\",\"ranges\":[]}";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/arturo\\/Escritorio\\/UDo\\/udo-core\\/db\\/patches\\/5.14.0\\/patches.json".ViMarks = "";
